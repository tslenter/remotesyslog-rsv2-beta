...
<head>
    ...
    <title>{{ config('app.name', 'RSv2') }}</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand font-weight-bold" style="font-size:30px" href="{{ url('/') }}">
                    <img src="/images/20180813_white_grey.png" width="40" height="40">
                    {{ config('app.name', 'RSv2') }}
                </a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/searches/create">Create</a>
